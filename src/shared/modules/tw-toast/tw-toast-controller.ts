...
import { TWToastOptions } from './tw-toast-options';


/**
 * @name TWToastController
 * @description
 ...
 * @usage
 * ```ts
 * constructor(private toastCtrl: TWToastController) {
 *
 * }
 *
 * presentToast() {
 ...
 */
@Injectable()
export class TWToastController {
   ...
   */
  create(opts: TWToastOptions = {}) {
    return new TWToast(this._app, opts, this.config);
  }
